...
## Development environment and release process
 ...
 - create virtualenv with Flask and Poem Generator installed into it (latter is installed in
...
install it (`pip install hseling_api_poem_generator.tar.gz`), ensure that configuration file exists and
`HSELING_API_POEM_GENERATOR_SETTINGS` environment variable points to it, ensure that user has access to the
